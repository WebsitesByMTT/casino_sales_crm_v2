    ...
    <>
      <div className='gradient-dashboard h-screen w-full'>
        <div className='grid grid-cols-12 h-[95%]'>
          {/* Left  */}
            <LeftSideBar logout={handelLogOut} user={userdetail} Tabs={Tabs} tabs={tabs} agenttab={agenttab} managerTab={managerTab} />
          {/* Left */}
            <RightSideBar user={userdetail} tabs={tabs} Tabs={Tabs} managerTab={managerTab} agenttab={agenttab} />
          {/* Right */}
        </div>
      </div>
